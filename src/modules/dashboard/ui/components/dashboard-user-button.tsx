...
export default function DashboardUserButton() {
  ...
  return (
    <DropdownMenu>
      <DropdownMenuTrigger className="rounded-lg broder border-border/10 p-3 w-full flex items-center justify-between bg-white/5 hover:bg-white/10 overflow-hidden">
        {data?.user?.image ? (
          <Avatar>
